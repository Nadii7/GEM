...
public class RegisterActivity extends AppCompatActivity {
    de.hdodenhof.circleimageview.CircleImageView user_pic;
    ...
    public void sign_Up() {
        ...
        if (name.isEmpty() || mail.isEmpty() || password.isEmpty() || PickedImgUri== null) {
    ...
    private void checkAndRequestForPermission() {
        if (ContextCompat.checkSelfPermission(RegisterActivity.this, Manifest.permission.READ_EXTERNAL_STORAGE)
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(RegisterActivity.this, Manifest.permission.READ_EXTERNAL_STORAGE)) {
                Toast.makeText(RegisterActivity.this, "PLEASE ACCEPT THE REQUIRED PERMISION", Toast.LENGTH_SHORT).show();
            } else {
